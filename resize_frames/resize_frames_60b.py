...
data = 'train'
if not os.path.exists('/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize2/'):
    os.makedirs('/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize2/')
...
for video in video_list:
    ...
    if not os.path.exists('/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize2/' + video + '/'):
        os.makedirs('/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize2/' + video + '/')
    for frame in frame_list:
        if frame != ".DS_Store":
            if os.stat('/Users/PycharmProjects/detect_sport_video/' + data + '_frame_videos2/' + video + '/' + frame).st_size > 0:
                ...
                image.save('/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize2/' + video + '/' + frame, quality=100)
