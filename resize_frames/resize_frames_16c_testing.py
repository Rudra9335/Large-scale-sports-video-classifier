...
data = 'test'
source_output_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize_16c/'
source_input_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_videos1/'
