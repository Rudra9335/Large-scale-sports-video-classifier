...
sys.stdout = open('output_16c_rmsprop_0.1lr', 'w')
...
rmsprop = RMSprop(lr=0.1, rho=0.9, epsilon=1e-08)
...
open('model_16c_rmsprop_0.1lr.json', 'w').write(json_string)
model.save_weights('model_16c_rmsprop_0.1lr.h5')
