...
video_list = sorted(os.listdir('/workspace/cogs260/team15/detect_sport_video/train_frame_resize1/'))
...
for video in video_list:
    if video != '.DS_Store':
        frame_index = 0
        frame_list = sorted(os.listdir(source_input_path))
...
open('model_16c.json', 'w').write(json_string)
model.save_weights('model_16c.h5')
