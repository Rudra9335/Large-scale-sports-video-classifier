...
data = 'test'
source_input_path = '/Users/PycharmProjects/detect_sport_video/sports-1m-dataset/' + data + '_correct_links.txt'
source_output_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_videos/'
video_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_output_videos/'
