...
data = 'validation'
source_input_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize_24c/'
...
model = model_from_json(open('model_24c.json').read())
model.load_weights('model_24c.h5')
