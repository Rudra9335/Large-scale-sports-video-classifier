...
data = 'train'
source_input_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize_40e/'
source_output_path  = '/Users/PycharmProjects/detect_sport_video/sports-1m-dataset/' + data + '_correct_links.txt'


input_data =np.zeros((860,50,1600))
...
model = model_from_json(open('model_40e.json').read())
model.load_weights('model_40e.h5')
