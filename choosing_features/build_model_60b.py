...
sequence_length = 50
dimension = 3600
#60 * 60 black and white
classes = 487

#Input and Output Path
data = 'train'
source_input_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize_60b/'
...
open('model_60b.json', 'w').write(json_string)
model.save_weights('model_60b.h5')
