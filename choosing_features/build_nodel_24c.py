...
data = 'train'
source_input_path = '/Users/PycharmProjects/detect_sport_video/' + data + '_frame_resize/'
...
open('model_24c.json', 'w').write(json_string)
model.save_weights('model_24c.h5')
